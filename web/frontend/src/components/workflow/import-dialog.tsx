        ...
        <div className="relative space-y-1 px-8">
          ...
          <DialogHeader className="space-y-1 text-center">
            <DialogTitle className="text-lg font-semibold tracking-tight">
              {t("pages.workflows.import_title")}
            </DialogTitle>
            <DialogDescription className="text-muted-foreground text-sm">
              {t("pages.workflows.import_description")}
            </DialogDescription>
          </DialogHeader>
        </div>
          ...
          >
            ...
            <div className="space-y-1">
              <div className="text-foreground text-sm font-semibold tracking-tight">
                {isDragActive
                  ? t("pages.workflows.import_drop_active")
                  : t("pages.workflows.import_drop_label")}
              </div>
              <p className="text-muted-foreground mx-auto hidden max-w-[270px] text-xs leading-relaxed sm:block">
                {isDragActive
                  ? t("pages.workflows.import_drop_release")
                  : t("pages.workflows.import_constraints")}
              </p>
            </div>
            <Button
              variant="secondary"
